...
protocol OperationCondition {
    ...
    */
    func dependencyForOperation(operation: AppOperation) -> Operation?
    
    /// Evaluate the condition, to see if it has been satisfied or not.
    func evaluateForOperation(operation: AppOperation, completion: @escaping (OperationConditionResult) -> Void)
}
...
struct OperationConditionEvaluator {
    static func evaluate(conditions: [OperationCondition], operation: AppOperation, completion: @escaping ([NSError]) -> Void) {
        // Check conditions.
        ...
        conditionGroup.notify(qos: DispatchQoS.background, flags: DispatchWorkItemFlags.assignCurrentContext, queue: DispatchQueue.main) {
